    ...
    return (
      <div>
        ...
        <div className="listResume">
          <button className={this.state.handled.skills ? 'skillsSelected' : 'skills'} onClick={() => this.handleClick("skills")}>
            Skills
          </button>
          <button
            className={this.state.handled.experience ? 'experienceSelected' : 'experience'}
            onClick={() => this.handleClick("experience")}>
            Experience
          </button>
          <button
            className={this.state.handled.education ? 'educationSelected' : 'education'}
        ...
        {this.state.handled.experience ? (
          <div className="filler">
            <div className="content">
              ...
              <p>
                Worked On an Agile Team building a React Native Application
                (iOS, android and Windows UWP) Was tasked with deploying builds
                and setting up the continous integration and creating final
                production builds with coordination with the off-shore team
                Build reusable components Unit testing using Jest Detailed
                documentation for processes
              </p>
              <p className="describe">React JS/PWA</p>
              <p>
                Building a ReactJS Progressive Web
                Application - knowledge of WorkBox and vanilla Service
                workers. Tons of iFrame work, indexedDb and many lifecycle events
              </p>
            </div>
          </div>
        ) : null}
        {this.state.handled.education ? (
          <div className="filler">
            <div className="content">
              ...
              <p>
                Graduated from the University of Central Florida in December
                2017{" "}
              </p>
